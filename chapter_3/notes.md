...
a and b have an element in common. One possiblity is:
...
the price of some repeated tests or an extra variable. For example, the arra
search becomes:
...
With a few exceptinos like those cited here, code that relies on goto
statements is generally harder to understand and to maintain than code without
gotos. Although we are not dogmatic about the matter, it does seem that goto
